  ...
  return (
    <div id="processQr" className="">
            ...
            <div className="max-w-6xl mx-auto w-full h-full xl:py-20">
                <div className="flex items-center gap-10 max-sm:my-4">
                    <div className="relative">
                        <div className=" rounded-full md:p-14 p-6 shadow-primary-main relative" style={{
                    ...
                    <div className="flex items-center max-md:flex-col max-md:text-center md:gap-5">
                        <div className={`bg-white md:h-20 md:w-20 h-5 w-5 text-sm xl:text-[3.7rem] flex justify-center items-center rounded-full font-extrabold  ${Plusjakartasans.className}`}  style={{  WebkitTextStrokeWidth: '2px',  WebkitTextStrokeColor: 'var(--Main, #FA7436)'}}>
                            1
                        </div>
                        <div>
                ...
                <div className="flex items-center justify-end gap-10 max-sm:py-4">
                    <div className="flex items-center max-md:flex-col max-md:text-center md:gap-5">
                        <div className={`bg-white md:h-20 md:w-20 h-5 w-5 text-sm xl:text-[3.7rem] flex justify-center items-center rounded-full font-extrabold  ${Plusjakartasans.className}`}  style={{  WebkitTextStrokeWidth: '2px',  WebkitTextStrokeColor: 'var(--Main, #FA7436)'}}>
                            2
                        </div>
        ...
        <section className="bg-primary-main md:w-full w-[90%] text-white md:p-6 p-2 rounded-2xl max-w-6xl mx-auto">
            <h1 className={`xl:text-5xl md:text-3xl text-xl  font-medium text-center max-w-5xl mx-auto md:my-10 my-2 ${volkhvo.className}`}>Start Using Digital <br /> Menus Now !</h1>
            <div className="w-full flex justify-center">
                <div className="bg-white text-primary-main text-lg font-medium md:py-2.5 py-1.5 px-4 rounded shadow-[0px_8px_16px_0px_rgba(0,0,0,0.16)]"><FormPopup name="Get Free Demo" /></div>
            </div>
        </section>
