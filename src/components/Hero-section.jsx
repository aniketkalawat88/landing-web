...
const HeroSection = () => {
  return (
    <div id="home" className={`text-center md:py-10 py-4 md:mt-[10vw] mt-[17vh] md:px-0 px-6 relative`}>
        ...
        <div className="bg-primary-main md:h-[20vw] h-[50vw] w-[20vw] absolute top-1/2 -z-10 left-6" style={{filter:'blur(250px)'}} />
        <div className="bg-primary-main md:h-[20vw] h-[50vw] w-[20vw] absolute top-1/2 -z-10 right-6" style={{filter:'blur(250px)'}} />
    </div>
  )
}
